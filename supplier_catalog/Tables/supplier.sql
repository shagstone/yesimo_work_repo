...
CREATE TABLE IF NOT EXISTS supplier (
  ...
  supplier_type_id INT NOT NULL COMMENT 'Unique Identifier for suppliers' ,
--   supplier_guid CHAR(32) NOT NULL COMMENT 'internally created guid for the supplier',
  ...
  vat varchar(32) DEFAULT NULL COMMENT 'value added tax',
  supplier_url varchar(200) NULL COMMENT 'supplier URL',
...
--   hold_reason_id INT NULL COMMENT 'Unique Identifier for hold_reason' ,
  ...
  CONSTRAINT fk_suppl_suppl_type
  FOREIGN KEY (supplier_type_id)
  REFERENCES supplier_catalog.supplier_type (supplier_type_id)
  ON DELETE NO ACTION
  ON UPDATE NO ACTION
)
