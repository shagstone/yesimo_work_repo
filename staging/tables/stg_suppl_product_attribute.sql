...
CREATE TABLE IF NOT EXISTS stg_suppl_product_attribute (
  ...
  prod_attribute_id INT NOT NULL AUTO_INCREMENT  COMMENT 'system generated unique identifier for staging product atttribute table',
  ...
  CONSTRAINT PK_supplier_stg_suppl_product_id PRIMARY KEY ( prod_attribute_id, stg_suppl_product_id),
