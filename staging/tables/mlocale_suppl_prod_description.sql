...
CREATE TABLE IF NOT EXISTS mlocale_suppl_prod_description (
  ...
  CONSTRAINT PK_merg_suppl_prod_descrip PRIMARY KEY (merg_suppl_prod_id, merg_suppl_prod_descrip_id, locale_id),
  CONSTRAINT fk_mlocale_merg_suppl_prod_descrip
  FOREIGN KEY (merg_suppl_prod_id, merg_suppl_prod_descrip_id )
  REFERENCES staging.merg_suppl_prod_description (merg_suppl_prod_id, merg_suppl_prod_descrip_id  )
  ON DELETE NO ACTION
  ON UPDATE NO ACTION
)
