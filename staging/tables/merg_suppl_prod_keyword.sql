...
DROP TABLE IF EXISTS merg_suppl_prod_keyword ;


CREATE TABLE IF NOT EXISTS merg_suppl_prod_keyword (
  merg_suppl_prod_id INT NOT NULL COMMENT 'merge supplier product table unique identifier',
  merg_suppl_prod_keywrd_id INT NOT NULL AUTO_INCREMENT  COMMENT 'Unique Identifier for merge supplier product atttribute',
  ...
  CONSTRAINT PK_merg_suppl_prod_keywrd PRIMARY KEY ( merg_suppl_prod_keywrd_id, merg_suppl_prod_id),
  CONSTRAINT fk_merg_suppl_prod_keywrd_product
