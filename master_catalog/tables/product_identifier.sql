...
CREATE TABLE IF NOT EXISTS product_identifier (
  ...
  product_ident_id INT NOT NULL AUTO_INCREMENT COMMENT 'product identifier unique identifier',
  ...
  CONSTRAINT PK_product_id PRIMARY KEY (product_ident_id),
  CONSTRAINT UQ_product_id UNIQUE KEY (product_id, prod_identifier_type_id),
